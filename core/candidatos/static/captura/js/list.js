            ...
            columnDefs: [
                ...
                }, 
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        content += '<a class="dropdown-item" href="' + '/candidato/captura/update/' + row.id + '/"><i class="fas fa-edit"></i> Editar</a>';
                        content += '<a class="dropdown-item" href="' + '/candidato/captura/detail/' + row.id + '/"><i class="fas fa-id-card"></i> Detalle</a>';
