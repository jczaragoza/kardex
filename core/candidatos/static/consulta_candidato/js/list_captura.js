            ...
            columnDefs: [
                ...
                }, 
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        content += '<a class="dropdown-item" href="' + '/candidato/consulta/update/' + row.id + '/"><i class="fas fa-edit"></i> Editar</a>';
                        content += '<a class="dropdown-item" href="' + '/candidato/consulta/detail/' + row.id + '/"><i class="fas fa-id-card"></i> Detalle</a>';
