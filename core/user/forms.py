...
class UserForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = 'first_name', 'last_name', 'username', 'password', 'dni', 'area', 'email', 'groups', 'image', 'is_active'
        widgets = {
            ...
            'area': forms.TextInput(attrs={'placeholder': 'Ingrese su área de adscripción'}),
