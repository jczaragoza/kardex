...
class User(AbstractUser):
    dni = models.CharField(max_length=13, unique=True, verbose_name='Clave SP')
    area = models.CharField(max_length=255, null=True, blank=True,  verbose_name='Área de adscripción')
