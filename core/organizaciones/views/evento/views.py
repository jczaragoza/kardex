...
#Import model & form
from core.organizaciones.forms import EventoForm
from core.organizaciones.models import Evento
...
class EventoListView(PermissionMixin, ListView, LoginRequiredMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('organizaciones:evento_create')
        context['list_url'] = reverse_lazy('organizaciones:evento_list')
...
class EventoCreateView(PermissionMixin, LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('organizaciones:evento_list')
