...
class OrgListView(PermissionMixin, ListView, LoginRequiredMixin):
    model = Organizacion
    template_name = 'captura_org/list.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('organizaciones:org_create')
        context['list_url'] = reverse_lazy('organizaciones:org_list')
        context['entity'] = 'Organizaciones'
        return context

class OrgCreateView(PermissionMixin, LoginRequiredMixin, CreateView):
    model = Organizacion
    template_name = 'captura_org/create.html'
    form_class = OrganizacionForm
    success_url = reverse_lazy('organizaciones:org_list')
...
class OrgUpdateView(PermissionMixin, UpdateView, LoginRequiredMixin):
    model = Organizacion
    form_class = OrganizacionForm
    template_name = 'captura_org/create.html'
    success_url = reverse_lazy('organizaciones:org_list')
...
class OrgDetailView(PermissionMixin, LoginRequiredMixin, DetailView):
    template_name = 'captura_org/detail.html'
