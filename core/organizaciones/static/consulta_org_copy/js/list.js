            ...
            columnDefs: [
                ...
                // }, 
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        //content += '<a class="dropdown-item" href="' + '/organizaciones/update/' + row.id + '/"><i class="fas fa-edit"></i> Editar</a>';
                        content += '<a class="dropdown-item" href="' + '/organizaciones/consulta/detail/' + row.id + '/"><i class="fas fa-id-card"></i> Detalle</a>';
