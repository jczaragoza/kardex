...
from core.fichas.models import Partido
...
class PartidoListView(PermissionMixin, ListView, LoginRequiredMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('fichas:partido_create')
        context['list_url'] = reverse_lazy('fichas:partido_list')
...
class PartidoCreateView(PermissionMixin, LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('fichas:partido_list')
