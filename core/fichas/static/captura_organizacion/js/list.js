            ...
            columnDefs: [
                ...
                }, 
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        content += '<a class="dropdown-item" href="' + '/fichas/captura/org/update/' + row.id + '/"><i class="fas fa-edit"></i> Editar</a>';
                        content += '<a class="dropdown-item" href="' + '/fichas/captura/org/detail/' + row.id + '/"><i class="fas fa-id-card"></i> Detalle</a>';
                        //content += '<a class="dropdown-item" target="_blank" href="/report/organizacion/pdf/' + row.id + '/"><i class="fas fa-file-pdf"></i>PDF</a>';
                        //content += '<a class="dropdown-item" href="' + '/fichas/org/delete/' + row.id + '/"><i class="fas fa-trash"></i> Eliminar</a>';
