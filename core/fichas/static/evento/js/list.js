            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        content += '<a class="dropdown-item" href="' + '/fichas/evento/update/' + row.id + '/"><i class="fas fa-edit"></i> Editar</a>';
                        content += '<a class="dropdown-item" href="' + '/fichas/evento/delete/' + row.id + '/"><i class="fas fa-trash"></i> Eliminar</a>';
                        return content;
