...
$(function () {
    ...
    //             $('select[name="eventos"]').append(newOption).trigger('change');
    ...
    //     submit_formdata_with_ajax('Notificación',
    //         '¿Estas seguro de agregar domicilio?',
    //         pathname,
    //         parameters,
    //         function (response) {
    //             var newOption = new Option(response.nombre, response.id, false, true);
    ...
    // $('#frmExperiencia').on('submit', function (e) {
    //     e.preventDefault();
    //     var parameters = new FormData(this);
    //     parameters.append('action', 'add_experiencia');
